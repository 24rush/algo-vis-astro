...
# Utilizarile limbajului Javascript #
...
Este foarte important să avem răbdare în acest proces de învățare al unui limbaj de programare și să avem încredere că multe lucruri care poate la momentul respectiv nu par foarte interesante, fac parte din fundația ce ne va ajuta să construim jocul sau aplicația de telefon la care visăm. Vă invit astfel să începeți studiul materialelor următoare pentru a face primi pași în această direcție.
