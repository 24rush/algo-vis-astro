...
<Algovis config_id="structuri-control-basics.json" av_selected="0"></Algovis>
...
<Algovis config_id="structuri-control-basics.json"  av_selected="1"></Algovis>
...
<code>i++</code> este expresia ce se vă executa după fiecare iterație, în cazul nostru vă aduna 1 de fiecare dată la valoarea lui i, făcându-l după fiecare iterație să se apropie de 100 până când vă ajunge la 101 iar condiția <code>i &lt;&equals; 100</code> va deveni falsă și întrerupe bucla.
...
<Algovis config_id="structuri-control-basics.json" av_selected="3"></Algovis>
...
<Algovis config_id="structuri-control-basics.json" av_selected="4"></Algovis>

<Box info>Cuvânt cheie <code>break1</code> va determina ieșirea din blocurile <code>switch, while, for, do-while</code></Box>
...
<Algovis config_id="structuri-control-basics.json" av_selected="5"></Algovis>
...
<Algovis config_id="structuri-control-basics.json" av_selected="2"></Algovis>
