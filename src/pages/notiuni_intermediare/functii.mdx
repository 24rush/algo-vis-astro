...
<Algovis config_id="functii-basics.json" av_selected="3"></Algovis>
...
<iframe style="aspect-ratio: 16/9; width:100%" src="https://www.youtube.com/embed/5tmtBjdw62w" title="Functions | Computer Programming | Khan Academy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" credentialless allowfullscreen></iframe>
...
<Algovis config_id="functii-basics.json" av_selected="1"></Algovis>
