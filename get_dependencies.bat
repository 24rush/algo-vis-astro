:: Copy bundle.js and 838.bundle.js from the Algovis repository to the assets and dist folders
copy /Y "..\Algo-Vis\build\838.bundle.js" "..\algo-vis-astro\public\assets\scripts\"
copy /Y "..\Algo-Vis\build\bundle.js" "..\algo-vis-astro\public\assets\scripts\"

copy /Y "..\Algo-Vis\build\838.bundle.js" "..\algo-vis-astro\dist\assets\scripts\"
